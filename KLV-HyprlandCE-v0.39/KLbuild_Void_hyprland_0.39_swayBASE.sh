...
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA-Hyprland/plugin-0.39/f_00_Void_wayland_hyprland_0.39_no-kernelBASE.plug
...
./build_firstrib_rootfs.sh void default amd64 f_00_Void_wayland_hyprland_0.39_no-kernelBASE.plug
